...
class Settings(BaseSettings):
    ...
    symbolic_weight: float = Field(default=0.3, ge=0.0, le=1.0)
    failure_penalty: float = 0.4
    ...
    boundary_threshold: float = Field(default=0.4, ge=0.0, le=1.0)

    # TTL
    hot_tier_ttl_seconds: int = 86400
